...
def main():
    ...
    logger.info(f"Batch size: {training_config.get('per_device_train_batch_size')}")
    logger.info(f"Gradient accumulation: {training_config.get('gradient_accumulation_steps')}")
    logger.info("=" * 60)
